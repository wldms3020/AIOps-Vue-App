  ...
  <div class="main-content bg-default">
    ...
    >
      <div slot="brand" class="navbar-wrapper">
        <b-navbar-brand to="/">
          <img style="margin-right: 5px;" src="img/brand/logo.png">
          <span style="font-size: 18px; color: white;">AIOPS</span>
        </b-navbar-brand>
      </div>
        ...
        <b-row align-v="center" class="justify-content-xl-between">
          <b-col xl="6">
            <div class="copyright text-center text-xl-left text-muted">
              © {{year}} <a class="font-weight-bold ml-1" target="_blank">Lee Jieun</a>
            </div>
          </b-col>
